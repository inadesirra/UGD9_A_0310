...
import com.example.ugd9_a_0310.models.Produk;
...
public class AddEditActivity extends AppCompatActivity {
    ...
    private void getProdukById(long id) {
        ...
        StringRequest stringRequest = new StringRequest(GET,
                ProdukApi.GET_BY_ID_URL + id, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                Glide.with(getApplicationContext()).load(produk.getGambar()).into(ivGambar);
    ...
    private void updateProduk(long id) {
        ...
        StringRequest stringRequest = new StringRequest(PUT,
                ProdukApi.UPDATE_URL + id, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Gson gson = new Gson();
                 /* Deserialiasai data dari response JSON dari API
